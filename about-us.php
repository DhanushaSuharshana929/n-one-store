            ...
            <div id="content" >
                ...
                <div class="container about-us-page-container"> 
                    ...
                    <div class="team-circle">
                        <div class="row">
                            <h2 class="title-shop-page">Our Team</h2>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item-team-circle item-team-circle1">
                                    <div class="team-circle-thumb">
                                        <img src="images/pages/team3.jpg" alt="" class="team-cirle-image">
                                    ...
                                    <div class="team-circle-info">
                                        <h3><a href="#">Great Illustration</a></h3>
                                        <span>Founder &amp; CEO</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item-team-circle item-team-circle2">
                                    <div class="team-circle-thumb">
                                        <img src="images/pages/team2.jpg" alt="" class="team-cirle-image">
                                        <div class="info-circle-thumb">
                                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                            <ul class="team-circle-social-network list-inline">
                                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item-team-circle item-team-circle3">
                                    <div class="team-circle-thumb">
                                        <img src="images/pages/team4.jpg" alt="" class="team-cirle-image">
                                        <div class="info-circle-thumb">
                                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                            <ul class="team-circle-social-network list-inline">
                                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="item-team-circle item-team-circle4">
                                    <div class="team-circle-thumb">
                                        <img src="images/pages/team1.jpg" alt="" class="team-cirle-image">
                                        <div class="info-circle-thumb">
                                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                            <ul class="team-circle-social-network list-inline">
                                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
